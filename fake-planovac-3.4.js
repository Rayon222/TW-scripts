...
</div><div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:12px"><label>Skupiny výchozích vesnic<br><select id="mkgroup" multiple size="7" style="width:100%;height:150px"><option value="">Načítám skupiny…</option></select><br><small>Označ více skupin pomocí Ctrl/Cmd. Volba „Všechny vesnice“ má přednost před ostatními.</small></label><label>Vesnice ve vybraných skupinách<br><select id="mkvillages" multiple size="8" style="width:100%"></select><br><small>Bez označení se použijí všechny načtené vesnice.</small></label><label>Cílové vesnice<br><textarea id="mktarget" rows="8" placeholder="500|500&#10;501|501&#10;502|502" style="width:100%;box-sizing:border-box"></textarea><br><small>Cíle mohou být oddělené řádkem, mezerou, čárkou nebo středníkem.</small><div id="mktargetstatus" style="margin-top:5px;font-weight:bold"></div></label><label>Automatické složení fake<br>
