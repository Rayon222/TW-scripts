...
async function initGroups(){
 ...
 const urls=[
  ...
  `/game.php?village=${encodeURIComponent(gd.village?.id||"")}&screen=overview_villages&mode=combined`
 ];
 ...
 for(const url of urls){
  try{
   ...
   console.warn("Skupiny: nepodařilo se načíst",url,e);
  }
 }
 ...
 renderGroups();
 setStatus(`Načteno skupin: ${groups.length}.`);
}
