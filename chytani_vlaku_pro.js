(() => {
  ...
  app.innerHTML = `
    ...
    <div style="padding:14px">
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-top:11px">
        <label>
          Limit zrušení
  ...
  const buildPlan = () => {
    ...
    trains.forEach((train, trainIndex) => {
      ...
      const plannedCancel = wantedReturn - limit;
      const plannedSend = plannedCancel - limit;
