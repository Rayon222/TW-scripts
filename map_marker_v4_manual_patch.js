(async () => {
  try {
    ...
    const paint = (x, y) => {
      ...
      el.style.borderRadius = mark && mark.shape==='circle' ? '50%' : '';
    ...
    panel.innerHTML = `
      <div style="display:flex;justify-content:space-between;align-items:center;gap:8px">
        <b style="font-size:16px">Označení vesnic v4</b>
      ...
      <div id="mkmm_body" style="margin-top:8px">
        ...
        <div style="display:grid;gap:5px;margin-top:9px">
          ...
          <label style="display:block"><input id="mkmm_circle" type="checkbox"> Kruh</label>
        </div>
    ...
    const stopBtn = $('#mkmm_stop');
    if (stopBtn) stopBtn.onclick = destroy;
